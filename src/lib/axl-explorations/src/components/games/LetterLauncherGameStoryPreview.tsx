...
const storyScript = {
  ...
  kn: {
    intro: {
      narrator: "ನೀವು ಕ್ಯಾಪ್ಟನ್ ರಾಹಿ, ಧೈರ್ಯಶಾಲಿ ಸಣ್ಣ ಬಾಹ್ಯಾಕಾಶ ಯಾತ್ರಿ.",
      rocket: "ನಿಮ್ಮ ರಾಕೆಟ್ ಲಾಂಚ್ ಪ್ಯಾಡ್‌ನಲ್ಲಿ ಕಾಯುತ್ತಿದೆ, ಹೊಳೆಯುತ್ತಾ ಮತ್ತು ನಿಶ್ಯಬ್ದವಾಗಿ ಗುನುಗುತ್ತಾ.",
      destination: "ಇಂದು, ನೀವು ಬಾಹ್ಯಾಕಾಶ ಪ್ರಯಾಣ ಮಾಡುತ್ತೀರಿ!",
      planet: "🌙"
    },
    riloAppears: {
      rilo: "ಕ್ಯಾಪ್ಟನ್ ರಾಹಿ! ನಮ್ಮ ರಾಕೆಟ್ ಹಾರಲು ಸಿದ್ಧವಾಗಿದೆ ಆದರೆ ಅದಕ್ಕೆ ಇಂಧನ ಬೇಕು!",
      fuelRequirement: "ನಮಗೆ ಗೆಲಾಕ್ಸಿಯ ಮೂಲಕ ಪ್ರಯಾಣಿಸಲು ಇಂಧನ ಘಟಕಗಳು ಬೇಕು.",
      fuelExplanation: "ನಿಮ್ಮ ಸೂಪರ್ ಕೇಳುವ ಕಿವಿಗಳನ್ನು ಬಳಸಿಕೊಂಡು ನಾವು ಇಂಧನವನ್ನು ತಯಾರಿಸಬಹುದು!",
      gameExplanation: "ನೀವು ಒಂದು ಧ್ವನಿಯನ್ನು ಕೇಳುತ್ತೀರಿ, ನೀವು ಒಂದು ಅಕ್ಷರವನ್ನು ನೋಡುತ್ತೀರಿ, ಮತ್ತು ಅವು ಹೊಂದಿಕೆಯಾದರೆ, ನಮಗೆ ರಾಕೆಟ್‌ಗೆ ಇಂಧನ ಸಿಗುತ್ತದೆ!",
      rocket: "🚀"
    },
    practice: {
      intro: "ನಮ್ಮ ನಿಜವಾದ ಪ್ರಯಾಣಕ್ಕೆ ಮೊದಲು ಸ್ವಲ್ಪ ಅಭ್ಯಾಸ ಮಾಡೋಣ!",
      question: "ಅವು ಒಂದೇ ಧ್ವನಿಯನ್ನು ನೀಡುತ್ತವೆಯೇ?",
      controls: "ನೀವು ನಿಮ್ಮ ಸ್ವಂತ ರೀತಿಯಲ್ಲಿ ಆಯ್ಕೆ ಮಾಡಬಹುದು!\n\nನೀವು ಅವು ಹೊಂದಿಕೆಯಾಗುತ್ತವೆಂದು ಭಾವಿಸಿದರೆ,\n← ಕೀಯನ್ನು ಒತ್ತಿ.\n\nನೀವು ಅವು ಹೊಂದಿಕೆಯಾಗುವುದಿಲ್ಲವೆಂದು ಭಾವಿಸಿದರೆ,\n→ ಕೀಯನ್ನು ಒತ್ತಿ.\n\nಅಥವಾ ನೀವು ✓ ಅಥವಾ ✗ ಬಟನ್‌ಗಳನ್ನು ಕ್ಲಿಕ್ ಮಾಡಬಹುದು!\n\nಯಾವುದು ಸುಲಭವೆಂದು ಅನಿಸುತ್ತದೆಯೋ,\nನೀವು ರಾಕೆಟ್‌ಗೆ ಕ್ಯಾಪ್ಟನ್!",
    ...
    fuelExplanation: {
      rilo: "ನೀವು ಪ್ರತಿ ಬಾರಿ ಕೇಳಿ ಆಯ್ಕೆ ಮಾಡಿದಾಗ, ನಿಮ್ಮ ರಾಕೆಟ್‌ಗೆ ಹೆಚ್ಚು ಇಂಧನ ಸಿಗುತ್ತದೆ! ನೀವು ಪ್ರಶ್ನೆಗೆ ವೇಗವಾಗಿ ಉತ್ತರಿಸಿದರೆ, ನಿಮಗೆ ಹೆಚ್ಚು ಇಂಧನ ಸಿಗುತ್ತದೆ!",
      fuelMeter: "ಟ್ಯಾಂಕ್ ತುಂಬಿಸೋಣ, ಮತ್ತು ಗೆಲಾಕ್ಸಿಯನ್ನು ಅನ್ವೇಷಿಸೋಣ!!"
    },
    readyToStart: {
      rilo: "ನೀವು ನಿಮ್ಮ ಬಾಹ್ಯಾಕಾಶ ಪ್ರಯಾಣವನ್ನು ಪ್ರಾರಂಭಿಸಲು ಸಿದ್ಧರಾಗಿದ್ದೀರಾ, ಕ್ಯಾಪ್ಟನ್?",
